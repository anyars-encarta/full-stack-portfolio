    ...
    <>
      ...
      <div className='app__work-filter'>
        {categories.map((category, index) => (
          <div
            key={index}
            onClick={() => handleWorkFilter(category.title)}
            className={`app__work-filter-item app__flex p-text ${activeFilter === category.title ? 'item-active' : ''}`}
          >
            {category.title}
          </div>
        ))}
